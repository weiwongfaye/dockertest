...
/tmp/splunk/bin/splunk edit cluster-config -mode slave -secret secret12  -master_uri https://$MASTER_PORT_8089_TCP_ADDR:8089 -replication_port 9011 -auth admin:notchangeme
